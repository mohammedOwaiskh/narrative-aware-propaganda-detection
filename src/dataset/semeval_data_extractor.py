...
SEMEVAL_DATASET_DIR = os.path.join(DATA_DIR, "datasets-v2", "datasets")


def load_articles():
    articles = {}
    art_dir = os.path.join(SEMEVAL_DATASET_DIR, "train-articles")
...
def load_technique_labels():
    ...
    label_dir = os.path.join(SEMEVAL_DATASET_DIR, "train-labels-task2-technique-classification")
...
def main():
    ...
    out_path = os.path.join(DATA_DIR, "train_data.csv")
